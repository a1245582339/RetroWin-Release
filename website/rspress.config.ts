...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { name: 'keywords', content: 'RetroWin, Windows taskbar macOS, Windows 98 taskbar, Windows XP taskbar, Windows 7 taskbar, Windows 8.1 Start screen, Windows 10 taskbar, Windows 11 taskbar, macOS customization, retro UI, desktop customization, Mac taskbar app' }],
    ...
    ['script', { type: 'application/ld+json' }, JSON.stringify({
      ...
      "description": "RetroWin brings the nostalgic Windows 98/XP/7/8.1/10/11 taskbar experience to your Mac. Customize your desktop with retro aesthetics and vintage functionality.",
      "offers": {
        "@type": "Offer",
        "price": "8.8",
        "priceCurrency": "CNY"
  ...
  locales: [
    ...
    },
    {
      ...
      description: 'RetroWin 将经典的 Windows 98/XP/7/8.1/10/11 任务栏体验带到 Mac，用复古美学和怀旧功能自定义你的桌面。',
    },
  ],
  themeConfig: {
    socialLinks: [
